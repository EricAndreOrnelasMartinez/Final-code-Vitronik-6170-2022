...
public class Robot extends TimedRobot {
  ...
  public static ServoMotor m_servomotor;
  /**
  ...
  public void robotInit() {
    ...
    camera1.setResolution(70, 40);
    camera1.setBrightness(2);
    camera1.setFPS(5);
    camera2 = CameraServer.startAutomaticCapture();
    camera2.setResolution(70, 40);
    camera2.setBrightness(2);
    camera2.setFPS(5);
    Constants.init();
    m_intake = new Intake();
    m_chasis = new Chasis();
    m_servomotor = new ServoMotor();
    m_lifter = new Lifter();
    drive = new Drive(m_chasis);
    m_shooter = new Shooter();
    m_autonomous = new Autonomous();
    autonomous = new AutonomousCmd(m_autonomous, m_chasis, m_shooter);
